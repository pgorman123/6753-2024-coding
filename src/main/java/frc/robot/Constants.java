...
public final class Constants {
  ...
  public static class ArmContants{
    public static final int Arm1CANID = 9;
    public static final int Arm2CANID = 10;
    public static final int Arm3CANID = 11;

    public static final double Arm1toplimit = 45;
    public static final double Arm1bottomlimit = -2;
    ...
    public static final double Arm1SafeThreshold = 5;
