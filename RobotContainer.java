...
*/
        ...
        } else if (AutoConstants.AutoRoute == 1001){/*Blue Auto 1 2024 */
            ...
            TrajectoryB = TrajectoryGenerator.generateTrajectory(new Pose2d(2.2, 0, new Rotation2d(0)),
                            List.of(  
                                new Translation2d(0, -0.8)
                            ),
                                    new Pose2d(2.2, -1.5, new Rotation2d(0)),config);

            TrajectoryC = TrajectoryGenerator.generateTrajectory(new Pose2d(2.2, -1.5, new Rotation2d(0)),
                            List.of(  
                                new Translation2d(2.6, -1.7)
                            ),
                                    new Pose2d(3, -2, new Rotation2d(0)),config);

             TrajectoryD = TrajectoryGenerator.generateTrajectory(new Pose2d(3, -2, new Rotation2d(0)),
                            List.of(  
                                new Translation2d(3.5, -1.5)
                            ),
                                    new Pose2d(6.3, -1.5, new Rotation2d(0)),config);

              TrajectoryE = TrajectoryGenerator.generateTrajectory(new Pose2d(6.3, -1.5, new Rotation2d(0)),
                            List.of(  
                                new Translation2d(3.5, -1.5)
                            ),
                                    new Pose2d(2.2, 0, new Rotation2d(0)),config);
            ...
            TrajectoryA = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)),
                            List.of(  
                                new Translation2d(3.1, 0)
                                    ...
                                    new Pose2d(6.3, 0, new Rotation2d(0)),config);
            TrajectoryB = TrajectoryGenerator.generateTrajectory(new Pose2d(6.3, 0, new Rotation2d(0)),
                            List.of(  
                                    new Translation2d(5.7, 0)
                            ),
            ...
            TrajectoryC = TrajectoryGenerator.generateTrajectory(new Pose2d(5, 0, new Rotation2d(0)),
                            List.of(  
                                ...
                                new Pose2d(6.3, -1.7, new Rotation2d(0)),config);

             TrajectoryD = TrajectoryGenerator.generateTrajectory(new Pose2d(6.3, -1.7, new Rotation2d(0)),
                            List.of(  
                                    new Translation2d(5.7, -0.9)
                            ),
                                new Pose2d(5, 0, new Rotation2d(0)),config);
