...
public class Robot extends TimedRobot {
  ...
  private Command m_limelightcmd;
  ...
  public void robotInit() {
    ...
    m_limelightcmd = new LimelightCMD();
  ...
  public void robotPeriodic() {
    ...
    // Limelight SmartDashboard numbers
    // Running LimelightCMD
    m_limelightcmd = LimelightCMD.LimelightCMD();
